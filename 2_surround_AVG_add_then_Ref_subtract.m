clear all;
myFolder = 'D:\NCAI-Neurocomputation Lab\Custom tDCS Experiments\EEG\True data pre\EO_all\';
...
for k = 1:(length(Files_dir)-2)
    ...
    pop_saveset(EEG, new_name(1: length(new_name)-4), 'D:\NCAI-Neurocomputation Lab\Custom tDCS Experiments\MindFoster_tDCS_Paper\Data\1_38 ch Data with surrod AVG add and A1A2 minus\Pre EO');
end
