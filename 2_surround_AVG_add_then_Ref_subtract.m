...
for k = 1:(length(Files_dir)-2)
    ...
    data(32,:) = EEG.data(23,:) - EEG.data(40,:);
    data(33,:) = EEG.data(24,:) - EEG.data(39,:);
    data(34,:) = EEG.data(25,:) - EEG.data(39,:);
    data(35,:) = EEG.data(26,:) - EEG.data(40,:);
    data(36,:) = EEG.data(27,:) - EEG.data(40,:);
    data(37,:) = EEG.data(28,:) - EEG.data(40,:);
    data(38,:) = EEG.data(29,:) - EEG.data(39,:);
       
    
    EEG.data = data;
    EEG.nbchan = 38;
    EEG = pop_chanedit(EEG , 'lookup' , 'E:\\eeglab_current\\eeglab2020_0\\plugins\\dipfit\\standard_BESA\\standard-10-5-cap385.elp' , 'load',{'E:\eeglab_current\eeglab2020_0\sample_locs\Standard-10-10-Cap40.ced' , 'filetype' , 'autodetect'});
    
    EEG_Data{k} = EEG;
    new_name = Files_dir(k+2).name;    
    pop_saveset(EEG, new_name(1: length(new_name)-4), 'D:\NCAI-Neurocomputation Lab\Custom tDCS Experiments\MindFoster_tDCS_Paper\Data\1_38 ch Data with surrod AVG add and A1A2 minus\Post EO');
end
